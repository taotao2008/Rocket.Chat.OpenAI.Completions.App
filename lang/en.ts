export const en = {
    ...
    reminder: {
        createModal: {
            ...
            ref_message_caption_sep: (channel?: string) => `您正在创建智能伴奏分离任务，请在消息对话框里上传文件，然后粘贴文件链接`,
        ...
        messageAction: {
            caption: '- 请输入您要提问的问题，也可使用语音进行提问 \n\n - 您还可以通过单击消息旁边操作菜单 `\uD83C\uDFB9 打开AI问答对话框` 按钮进行提问',
            button_ask: 'AI问答',
            button_blend: '多图融合',
            button_describe: '创建图逆',
            button_doc: '获取教程',
        },
    },
};
